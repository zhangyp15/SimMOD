...
def create_nuscenes_infos(
    ...
    if test:
        ...
        info_path = osp.join(save_path, "{}_infos_test.pkl".format(info_prefix))
        ...
        data = dict(infos=train_nusc_infos, metadata=metadata)
        info_path = osp.join(save_path, "{}_infos_train.pkl".format(info_prefix))
        mmcv.dump(data, info_path)
        data["infos"] = val_nusc_infos
        info_val_path = osp.join(save_path, "{}_infos_val.pkl".format(info_prefix))
