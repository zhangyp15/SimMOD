...
def nuscenes_data_prep(
    ...
    save_path = save_path or root_path
    import os
    ...
    if version == "v1.0-test":
        info_test_path = osp.join(save_path, f"{info_prefix}_infos_test.pkl")
    ...
    # export 2d annotations for proposal generation
    info_train_path = osp.join(save_path, f"{info_prefix}_infos_train.pkl")
    nuscenes_converter.export_2d_annotation(
        root_path,
        info_train_path,
        version=version,
    ...
    info_val_path = osp.join(save_path, f"{info_prefix}_infos_val.pkl")
    nuscenes_converter.export_2d_annotation(
        root_path,
        info_val_path,
        version=version,
    ...
    ''' 
    optionally: prepare the trainval set for test submission
    '''
    # info_trainval_path = osp.join(save_path, f"{info_prefix}_infos_trainval.pkl")
    # nuscenes_converter.export_2d_annotation(
    #     root_path,
    #     info_trainval_path,
    #     version=version,
