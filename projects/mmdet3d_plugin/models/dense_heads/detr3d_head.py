...
class Detr3DHead(DETRHead):
    ...
    def forward(self, mlvl_feats, img_metas, raw_img=None):
        """Forward function.
        Args:
    ...
    def loss_single(
        ...
        # xyz in lidar, dim, orientation, velocity
        # valid_bbox_targets = bbox_targets[isnotnan]
        # valid_normalized_bbox_targets = normalized_bbox_targets[isnotnan]
        # matched_bbox_preds = bbox_preds[isnotnan]
        ...
        # print(
        #     "num_total_pos = {}, per-attribute loss: ".format(num_total_pos),
        #     my_loss_bbox,
        # )
