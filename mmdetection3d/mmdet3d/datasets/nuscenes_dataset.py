...
class NuScenesDataset(Custom3DDataset):
    ...
    def __init__(
        ...
        self.visualize_tokens = [
            "1d6c7fdb1bbb41c4851a6a2913ea6144",
            "0af0feb5b1394b928dd13d648de898f5",
            "0ad5d20390ec43f59d210c1a3a11b23d",
        ]

        if self.visualize_mode:
            visualize_data_infos = []
            for info in self.data_infos:
                if info['token'] in self.visualize_tokens:
                    visualize_data_infos.append(info)
            
            self.data_infos = visualize_data_infos
